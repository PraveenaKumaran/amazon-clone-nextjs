...
// Example signup function; replace with your actual implementation or import
async function signup(email: string, password: string) {
  // Replace the URL and request as needed for your backend
  ...
  return (
    <section className="bg bg-gray-50 dark:bg-gray-900">
      <div className = " flex flex-col items-center justify-center px-6 py-8 mx-auto h-screen lg:py-0" >
        <a href = "#"
        className = "flex items-center mb-2 text-2xl2xl: font-semibold text-shadow-gray-900 dark:text-white" 
        >
          <Image
          src = "/amazon-logo.png"
          alt = "amazon logo"
            ...
            <div className="space-y-4 md:space-y-6">
              <div>
                ...
                <p className="text-sm font-light text-gray-500 dark:text-gray-400">
                  ...
                  <Link href = "/login" className = "text-medium text-gray-700 hover:underline">
                  Login here
                  </Link>
                </p>
